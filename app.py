...
# --- TAB 2: SISTEM REKOMENDASI ---
    ...
    # Input dipindahkan ke Main Content dalam kolom agar rapi
    ...
    st.write(f"Sistem akan mencari kemiripan User **{target_user}** dengan pengguna lainnya.")
...
st.markdown("---")
st.caption("Final Project Sistem Rekomendasi - Universitas Amikom Yogyakarta")
